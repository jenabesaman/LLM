...
# device ="cpu"
#
# # Use accelerate to handle large model files
...
#
# # Use load_checkpoint_and_dispatch with the correct device
# model = load_checkpoint_and_dispatch(
#     model,
#     model_name,
#     device_map="auto",
#     offload_folder="offload",
#     offload_state_dict=True  # Enable offloading state dict to disk
# ).to(device)
#
